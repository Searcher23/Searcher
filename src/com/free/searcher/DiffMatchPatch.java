...
public class DiffMatchPatch {
	...
	public static String compare(String text1, String text2) {
		...
		long ms_start = (new Date()).getTime();
		LinkedList<Diff> d = dmp.diff_main(text1, text2);
		long ms_end = (new Date()).getTime();

		dmp.diff_cleanupSemantic(d);
		dmp.diff_cleanupEfficiency(d);
		String ds = dmp.diff_prettyHtml(d);
		Log.i("compare", "Time: " + NumberFormat.getInstance().format(ms_end - ms_start) + "ms");
		return ds;
	}
	...
	public String diff_prettyHtml(LinkedList<Diff> diffs) {
		...
		for (Diff aDiff : diffs) {
			...
			switch (aDiff.operation) {
				case INSERT:
					html.append("<ins style=\"background:#8080ff;\">").append(text)
						.append("</ins>");
					break;
				case DELETE:
					html.append("<del style=\"background:#ff8080;\">").append(text)
						.append("</del>");
					break;
				case EQUAL:
